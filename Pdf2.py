...
excel_path = 'C:/Users/ersal/OneDrive/Desktop/AUT_PYT/archivo_salida_simple.xlsx'
...
for filename in os.listdir(pdf_directory):
    if filename.lower().endswith('.pdf'):
        ...
        for page_num in range(len(doc)):
            ...
            # Verificar si el texto completo está en el PDF
            if search_text in text:
                found_text = search_text
                break
        
        # Guardar el resultado en el archivo Excel
        ws.append([filename, found_text])
